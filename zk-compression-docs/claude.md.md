...
│  ├─ Cookbook/
│  │  ├─ Index                                   (compressed-tokens/cookbook/README.md) — Overview of guides to compressed token operations with full code examples
...
│  │  ├─ Index                                   (compressed-pdas/compressed-pda-cookbook/README.md)
