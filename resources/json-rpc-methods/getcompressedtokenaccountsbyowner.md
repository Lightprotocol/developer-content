...
{% hint style="info" %}
You can test this method via the OpenAPI example or [custom examples below](getcompressedtokenaccountsbyowner.md#examples).
{% endhint %}

{% openapi-operation spec="get-compressed-balance-by-owner" path="/getCompressedTokenAccountsByOwner" method="post" %}
