...
1. The same `programIds` and account addresses as zkTestnet are used. The full details are listed in the [Devnet Addresses](../developers/protocol-addresses-and-urls.md) section
