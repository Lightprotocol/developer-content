...
{% content-ref url="../../zk-compression-docs/compressed-tokens/compressed-token-guides/how-to-create-and-register-a-mint-account-for-compression.md" %}
[how-to-create-and-register-a-mint-account-for-compression.md](../../zk-compression-docs/compressed-tokens/compressed-token-guides/how-to-create-and-register-a-mint-account-for-compression.md)
{% endcontent-ref %}
